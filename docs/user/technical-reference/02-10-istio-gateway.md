...
The Kyma Istio module is pre-installed by default on a managed Kyma runtime. Alternatively, a [custom Istio installation](https://kyma-project.io/02-get-started/01-quick-install.html) is also possible.
