...
import (
	...
	"github.com/kyma-project/kyma/application-connector-manager/components/central-application-gateway/internal/csrf"
	csrfClient "github.com/kyma-project/kyma/application-connector-manager/components/central-application-gateway/internal/csrf/client"
	csrfStrategy "github.com/kyma-project/kyma/application-connector-manager/components/central-application-gateway/internal/csrf/strategy"
	"github.com/kyma-project/kyma/application-connector-manager/components/central-application-gateway/internal/externalapi"
	"github.com/kyma-project/kyma/application-connector-manager/components/central-application-gateway/internal/metadata"
	"github.com/kyma-project/kyma/application-connector-manager/components/central-application-gateway/internal/metadata/applications"
	"github.com/kyma-project/kyma/application-connector-manager/components/central-application-gateway/internal/metadata/secrets"
	"github.com/kyma-project/kyma/application-connector-manager/components/central-application-gateway/internal/metadata/serviceapi"
	"github.com/kyma-project/kyma/application-connector-manager/components/central-application-gateway/internal/proxy"
	"github.com/kyma-project/kyma/application-connector-manager/components/central-application-gateway/pkg/apperrors"
	"github.com/kyma-project/kyma/application-connector-manager/components/central-application-gateway/pkg/authorization"
	"github.com/kyma-project/kyma/application-connector-manager/components/central-application-gateway/pkg/client/clientset/versioned"
	"github.com/kyma-project/kyma/application-connector-manager/components/central-application-gateway/pkg/httptools"
